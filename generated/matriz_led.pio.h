...
#define matriz_led_wrap_target 0
#define matriz_led_wrap 6
#define matriz_led_pio_version 0

static const uint16_t matriz_led_program_instructions[] = {
            //     .wrap_target
    0x6021, //  0: out    x, 1                       
    0x0024, //  1: jmp    !x, 4                      
...
#if !PICO_NO_HARDWARE
static const struct pio_program matriz_led_program = {
    .instructions = matriz_led_program_instructions,
    .length = 7,
    .origin = -1,
    .pio_version = matriz_led_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config matriz_led_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + matriz_led_wrap_target, offset + matriz_led_wrap);
    return c;
}

static inline void matriz_led_program_init(PIO pio, uint sm, uint offset, uint pin)
{
